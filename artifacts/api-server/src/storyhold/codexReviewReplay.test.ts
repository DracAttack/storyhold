...
function curatedFixture(): WorldFindings {
  return {
    ...
    characters: [{
      ...
      estimatedStats: {
        strength: { score: 10, confidence: 0.5, rationale: "ordinary" },
        dexterity: { score: 10, confidence: 0.5, rationale: "ordinary" },
        constitution: { score: 10, confidence: 0.5, rationale: "ordinary" },
        intelligence: { score: 10, confidence: 0.5, rationale: "ordinary" },
        wisdom: { score: 10, confidence: 0.5, rationale: "ordinary" },
        charisma: { score: 10, confidence: 0.5, rationale: "ordinary" },
        acrobatics: { score: 10, confidence: 0.5, rationale: "ordinary" },
      },
      socioPoliticalAxis: {
        economic: 0,
        authority: 0,
